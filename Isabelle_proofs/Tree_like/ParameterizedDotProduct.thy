...
lemma reliabilityDotProduct_kplus1 :
  "(k>0 \<and> ((length v1_1) = (power 2 k)) \<and> ((length v2_1) = (power 2 k)) \<and>
   ...
   \<Longrightarrow>
     Reliability (Tuple_ofT
              (computeDotProduct mul add)
              (global_latencyDotProduct mul add v1_2 v2_2 (k+1))
              (reliabilityDotProduct mul add relreg (k+1)))
    = (Reliability (Tuple_ofT
              (computeDotProduct mul add)
              (global_latencyDotProduct mul add v1_1 v2_1 k)
              (reliabilityDotProduct mul add relreg k)))
      * (1 + (1-relreg)^(2^(k+1))) 
      * (1 + (1-(Reliability2 mul))^(2^k)) * (reliabilityParal (Reliability2 add) k)"
  using reliabilityDotProduct_lem2
  by (metis CoreDotProduct.sel(3))
...
lemma reliabilityDotProduct_kplus1_inst1 :
  "(k>0 \<and> ((length v1_1) = (power 2 k)) \<and> ((length v2_1) = (power 2 k)) \<and>
   ...
   \<Longrightarrow>
     Reliability (Tuple_ofT
              (computeDotProduct (Tuple_of2 fmul_simple 0 r1) (Tuple_of2 fadd_simple 0 r2))
              (global_latencyDotProduct (Tuple_of2 fmul_simple 0 r1) 
                                        (Tuple_of2 fadd_simple 0 r2) v1_2 v2_2 (k+1))
              (reliabilityDotProduct (Tuple_of2 fmul_simple 0 r1)
                                     (Tuple_of2 fadd_simple 0 r2) relreg (k+1)))
    = (Reliability (Tuple_ofT
              (computeDotProduct (Tuple_of2 fmul_simple 0 r1) (Tuple_of2 fadd_simple 0 r2))
              (global_latencyDotProduct (Tuple_of2 fmul_simple 0 r1)
                                        (Tuple_of2 fadd_simple 0 r2) v1_1 v2_1 k)
              (reliabilityDotProduct (Tuple_of2 fmul_simple 0 r1) 
                                     (Tuple_of2 fadd_simple 0 r2) relreg k)))
      * (1 + (1-relreg)^(2^(k+1))) 
      * (1 + (1-(Reliability2 (Tuple_of2 fmul_simple 0 r1)))^(2^k)) 
      * (reliabilityParal (Reliability2 (Tuple_of2 fadd_simple 0 r2)) k)"
...
lemma reliabilityDotProduct_kplus1_inst2 :
  "(k>0 \<and> ((length v1_1) = (power 2 k)) \<and> ((length v2_1) = (power 2 k)) \<and>
   ...
   \<Longrightarrow>
     Reliability (Tuple_ofT
              (computeDotProduct (Tuple_of2 fmul_reg 1 r1) (Tuple_of2 fadd_reg 1 r2))
              (global_latencyDotProduct (Tuple_of2 fmul_reg 1 r1) 
                                        (Tuple_of2 fadd_reg 1 r2) v1_2 v2_2 (k+1))
              (reliabilityDotProduct (Tuple_of2 fmul_reg 1 r1)
                                     (Tuple_of2 fadd_reg 1 r2) relreg (k+1)))
    = (Reliability (Tuple_ofT
              (computeDotProduct (Tuple_of2 fmul_reg 1 r1) (Tuple_of2 fadd_reg 1 r2))
              (global_latencyDotProduct (Tuple_of2 fmul_reg 1 r1)
                                        (Tuple_of2 fadd_reg 1 r2) v1_1 v2_1 k)
              (reliabilityDotProduct (Tuple_of2 fmul_reg 1 r1) 
                                     (Tuple_of2 fadd_reg 1 r2) relreg k)))
      * (1 + (1-relreg)^(2^(k+1))) 
      * (1 + (1-(Reliability2 (Tuple_of2 fmul_reg 1 r1)))^(2^k)) 
      * (reliabilityParal (Reliability2 (Tuple_of2 fadd_reg 1 r2)) k)"
  using reliabilityDotProduct_kplus1
  by blast
